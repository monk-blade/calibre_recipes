...
class OnlyLatestRecipe(BasicNewsRecipe):
    ...
    conversion_options = { 'comment' : description, 'tags' : category, 'publisher' : publisher, 'language' : language, 'smarten_punctuation' : True , 'search_replace': '[["<img height=\\"21\\" width=\\"43\\" src=\\"images/00006.jpg\\".*/>", ""]]'}
